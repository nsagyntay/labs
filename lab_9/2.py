...
class Food:
    def __init__(self):
        ...
        # Added: Assign random weight to food (1, 2 or 3)
        self.weight = random.choice([1, 2, 3])
        # Added: Food spawn timestamp (for timer)
    ...
    def respawn(self):
        ...
        # Also assigns a new random weight upon respawn
        self.weight = random.choice([1, 2, 3])
        # Update food spawn time
        self.spawn_time = pygame.time.get_ticks()
...
while running:
    ...
    # If the food is too old, it disappears and new food appears
    ...
    # display the weight of the food next to it
    weight_text = font.render(str(food.weight), True, BLUE)
    screen.blit(weight_text, (food.position[0], food.position[1]))
